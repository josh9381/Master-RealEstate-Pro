      ...
      <DialogContent className="max-w-3xl max-h-[90vh] overflow-y-auto">
        ...
        <div className="space-y-6">
          ...
          <div>
            ...
            <div className="border border-border dark:border-gray-700 rounded-lg p-4 bg-muted/50 dark:bg-gray-800/50">
              {preview.messagePreview?.subject && (
                <div className="mb-3 pb-3 border-b border-border dark:border-gray-700">
                  <p className="text-xs text-muted-foreground dark:text-muted-foreground mb-1">Subject:</p>
              ...
              <div>
                <p className="text-xs text-muted-foreground dark:text-muted-foreground mb-2">Message:</p>
                <div 
                  className="text-sm text-foreground dark:text-muted-foreground whitespace-pre-wrap"
          ...
          {(preview.sampleRecipients || []).length > 0 && (
            <div>
              ...
              <div className="border border-border dark:border-gray-700 rounded-lg overflow-hidden">
                <div className="max-h-60 overflow-y-auto">
                  <table className="w-full text-sm">
                    <thead className="bg-muted/50 dark:bg-gray-800 sticky top-0">
                      <tr>
                        <th className="px-4 py-2 text-left font-medium text-foreground dark:text-muted-foreground">
                          Name
                        </th>
                        <th className="px-4 py-2 text-left font-medium text-foreground dark:text-muted-foreground">
                          Contact
                    ...
                    <tbody className="divide-y divide-gray-200 dark:divide-gray-700">
                      {(preview.sampleRecipients || []).map((recipient, idx) => (
                        <tr key={recipient.id || recipient.email || idx} className="hover:bg-muted/50 dark:hover:bg-gray-800/50">
                          <td className="px-4 py-2 text-foreground dark:text-white">
                            {recipient.name}
                          </td>
          ...
          {(preview.recipientCount || 0) > 0 && (
            <div className="bg-muted/50 dark:bg-gray-800/50 rounded-lg p-4 text-sm">
              ...
              <div className="space-y-1 text-muted-foreground dark:text-muted-foreground">
                ...
                <div className="flex justify-between pt-2 border-t border-border dark:border-gray-700 font-semibold text-foreground dark:text-white">
