...
export function AISMSComposer({ 
  ...
  return (
    <>
      ...
      {/* Modal */}
      <div className="fixed left-1/2 top-1/2 z-50 w-full max-w-lg -translate-x-1/2 -translate-y-1/2 rounded-2xl border border-border/40 bg-background shadow-2xl" role="dialog" aria-modal="true" aria-label="AI SMS Composer">
        {/* Header */}
        <div className="relative flex items-center justify-between border-b p-4 text-white rounded-t-2xl overflow-hidden">
          ...
          <div className="relative flex items-center space-x-3">
            ...
            <div>
              ...
              <p className="text-[11px] text-white/60">Smart text messages with AI</p>
            </div>
          </div>
          <button
            onClick={onClose}
