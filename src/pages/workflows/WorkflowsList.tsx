...
import { Workflow, Plus, Play, Pause, Edit, Trash2, BarChart3, RefreshCw, LayoutGrid, LayoutList, ChevronRight } from 'lucide-react';
      ...
      <div className="flex items-center justify-between">
        <div className="flex-1">
          <div className="flex items-center gap-3 mb-2">
            ...
            <Badge variant="outline" className="text-xs">Automation Hub</Badge>
          </div>
      ...
      <div className="grid gap-4 md:grid-cols-4">
        <Card className="hover:shadow-md transition-shadow">
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">
              {stats.activeWorkflows} active, {stats.inactiveWorkflows} paused
            </p>
        ...
        <Card className="hover:shadow-md transition-shadow">
          ...
          <CardContent>
            ...
            <p className="text-xs text-green-600 dark:text-green-400 font-medium">All time runs</p>
          </CardContent>
        </Card>
        <Card className="hover:shadow-md transition-shadow">
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">
              {stats.successfulExecutions} / {stats.totalExecutions} successful
            </p>
            <div className="mt-2 h-1 w-full bg-gray-200 dark:bg-gray-700 rounded-full overflow-hidden">
              <div 
        ...
        <Card className="hover:shadow-md transition-shadow">
          ...
          <CardContent>
            ...
            <p className="text-xs text-red-600 dark:text-red-400 font-medium">
              {stats.failedExecutions > 0 ? 'Need attention' : 'All good! 🎉'}
            </p>
          </CardContent>
        </Card>
      </div>
                  ...
                  <div className="flex items-start space-x-4 flex-1">
                    ...
                    <div className="flex-1">
                      ...
                      {Array.isArray(workflow.actions) && workflow.actions.length > 0 && (
                        <div className="py-3 px-4 bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-blue-950/20 dark:to-indigo-950/20 rounded-lg border border-blue-200 dark:border-blue-800">
