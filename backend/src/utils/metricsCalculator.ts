/**
 * Centralized Metrics Calculator — Backend
 *
 * Single source of truth for all rate/metric calculations.
 * Every service and controller MUST use these functions instead of inline math.
 *
 * Conventions:
...
/** Round a number to 2 decimal places (money, weights, credits, etc.). */
