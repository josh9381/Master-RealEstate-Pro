...
describe('Note Management Endpoints', () => {
    ...
    beforeEach(async () => {
        ...
        anotherUser = await database_1.prisma.user.create({
            data: {
                firstName: 'Another',
                lastName: 'User',
        ...
        anotherUserToken = (0, jwt_1.generateAccessToken)(anotherUser.id, anotherUser.email, anotherUser.role);
        // Create a test lead
    ...
    describe('GET /api/leads/:leadId/notes', () => {
        beforeEach(async () => {
            ...
            await database_1.prisma.note.createMany({
                data: [
                    {
                        content: 'First note',
                        leadId: testLead.id,
    ...
    describe('DELETE /api/notes/:id', () => {
        ...
        it('should delete note successfully (author)', async () => {
            ...
            const deletedNote = await database_1.prisma.note.findUnique({
                where: { id: noteId },
            });
        ...
        it('should allow admin to delete any note', async () => {
            ...
            const hashedPassword = await bcryptjs_1.default.hash('AdminPassword123!', 10);
            ...
            const adminToken = (0, jwt_1.generateAccessToken)(adminUser.id, adminUser.email, adminUser.role);
            const response = await (0, supertest_1.default)(app)
                .delete(`/api/notes/${noteId}`)
