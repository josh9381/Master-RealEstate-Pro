...
describe('Appointment System Integration Tests', () => {
    ...
    describe('Appointment Conflicts', () => {
        test('Should detect conflicting appointments', async () => {
            ...
            const response2 = await (0, supertest_1.default)(server_1.default)
                .post('/api/appointments')
                .set('Authorization', `Bearer ${authToken}`)
                .send({
    ...
    describe('Appointment Reminders', () => {
        test('Should schedule reminder for appointment', async () => {
            ...
            const reminderResponse = await (0, supertest_1.default)(server_1.default)
            ...
            const updatedResponse = await (0, supertest_1.default)(server_1.default)
    ...
    describe('Appointment Rescheduling', () => {
        test('Should reschedule appointment', async () => {
            ...
            const rescheduleResponse = await (0, supertest_1.default)(server_1.default)
